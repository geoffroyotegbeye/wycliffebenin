...
const Accueil = () => {
  ...
  useEffect(() => {
    if (slideRef.current && contentRef.current) {
      ...
      gsap.fromTo(
        contentRef.current,
        { y: 30, opacity: 0 },
        { y: 0, opacity: 1, duration: 1.2, delay: 0.3, ease: 'power1.out' }
      );
    }
  }, [currentSlide]);
  ...
  return (
    <div className="w-full">
      {/* Hero Carousel */}
      <div className="relative h-[calc(100vh-4rem)] overflow-hidden bg-blue-900">
      ...
      <div className="bg-blue-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap justify-center gap-4">
          ...
          <Link
            to="/pourquoi-traduire"
            className="bg-transparent border-2 border px-8 py-3 rounded-lg font-bold hover:bg-white hover:text-blue-900 transition"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <ScrollAnimation animation="scale" delay={0.1}>
              <div className="bg-white rounded-card shadow-card overflow-hidden hover:shadow-card-hover transition border-t-4 border-orange-600 group">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-blue-900 mb-3">Traduction Biblique</h3>
            ...
            <ScrollAnimation animation="scale" delay={0.2}>
              <div className="bg-white rounded-card shadow-card overflow-hidden hover:shadow-card-hover transition border-t-4 border-blue-900 group">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-blue-900 mb-3">Alphabétisation</h3>
                  <p className="text-gray-700 mb-4">
            ...
            <ScrollAnimation animation="scale" delay={0.3}>
              <div className="bg-white rounded-card shadow-card overflow-hidden hover:shadow-card-hover transition border-t-4 border-gray-800 group">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-blue-900 mb-3">Développement Linguistique</h3>
                  <p className="text-gray-700 mb-4">
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition border-l-4 border-orange-600">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-blue-900 mb-3">Centre de Conférence</h3>
                <p className="text-gray-700 mb-4">
                ...
                <ul className="text-gray-600 mb-4 space-y-2 text-sm">
                  <li className="flex items-center"><span className="text-orange-600 mr-2">✓</span> Installations de conférence</li>
                  <li className="flex items-center"><span className="text-orange-600 mr-2">✓</span> Hébergement</li>
                  <li className="flex items-center"><span className="text-orange-600 mr-2">✓</span> Forfaits mariage et jardins</li>
                  <li className="flex items-center"><span className="text-orange-600 mr-2">✓</span> Installations récréatives</li>
                  <li className="flex items-center"><span className="text-orange-600 mr-2">✓</span> Salon, Barbier, Lavage auto</li>
                </ul>
                <Link
                  to="/booking"
                  className="inline-flex items-center text-orange-600 font-semibold hover:text-orange-700 transition group"
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition border-l-4 border-blue-900">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-blue-900 mb-3">Entreprises Wycliffe</h3>
                <p className="text-gray-700 mb-4">
                ...
                <ul className="text-gray-600 mb-4 space-y-2 text-sm">
                  <li className="flex items-center"><span className="text-blue-900 mr-2">✓</span> Imprimerie</li>
                  <li className="flex items-center"><span className="text-blue-900 mr-2">✓</span> Librairie</li>
                  <li className="flex items-center"><span className="text-blue-900 mr-2">✓</span> Services de traduction</li>
                  <li className="flex items-center"><span className="text-blue-900 mr-2">✓</span> Formation linguistique</li>
                </ul>
                <Link
                  to="/services"
                  className="inline-flex items-center text-orange-600 font-semibold hover:text-orange-700 transition group"
          ...
          <div className="mt-8 rounded-lg overflow-hidden text-white shadow-xl">
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-8 bg-blue-900 flex flex-col justify-center">
                ...
                <Link
                  to="/nos-rdv"
                  className="inline-block bg-orange-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-orange-700 transition w-fit shadow-lg"
        ...
        {/* News & Events */}
        <section className="mb-20">
          <h2 className="text-4xl font-bold text-blue-900 mb-6 text-center">Actualités & Événements</h2>
          <p className="text-lg text-gray-700 text-center mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link
              to="/actualites"
              className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition group border-t-4 border-orange-600"
            >
              <div className="h-48 overflow-hidden">
                <img
                  src='/images/projet-10.webp'
              ...
              <div className="p-6">
                <span className="inline-block bg-primary-50 text-orange-600 text-xs px-3 py-1 rounded-full mb-2 font-medium">
                  9 Octobre 2024
                </span>
                ...
                <span className="inline-flex items-center text-orange-600 font-semibold group-hover:text-orange-700 transition">
                  Lire plus
                  <span className="ml-1 group-hover:translate-x-1 transition-transform">→</span>
                </span>
              </div>
            ...
            <Link
              to="/actualites"
              className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition group border-t-4 border-blue-900"
            >
              <div className="h-48 overflow-hidden">
                <img
                  src='/images/projet-11.webp'
              ...
              <div className="p-6">
                <span className="inline-block bg-secondary-50 text-blue-900 text-xs px-3 py-1 rounded-full mb-2 font-medium">
                  12 Septembre 2024
                </span>
                <h3 className="text-xl font-bold text-blue-900 mt-2 mb-3">
          ...
          <div className="text-center mt-8">
            <Link
              to="/actualites"
              className="inline-block bg-orange-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-orange-700 transition shadow-lg"
