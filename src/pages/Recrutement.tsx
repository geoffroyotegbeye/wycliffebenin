          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <ScrollAnimation animation="scale" delay={0.2}>
              <div className="bg-white rounded-card shadow-card hover:shadow-card-hover transition p-6 text-center">
                ...
                <h3 className="font-bold text-secondary mb-2">Équipe Passionnée</h3>
                <p className="text-gray-700 text-sm">
            ...
            <ScrollAnimation animation="scale" delay={0.3}>
              <div className="bg-white rounded-card shadow-card hover:shadow-card-hover transition p-6 text-center">
                ...
                <h3 className="font-bold text-secondary mb-2">Réseau International</h3>
                <p className="text-gray-700 text-sm">
            ...
            <ScrollAnimation animation="scale" delay={0.4}>
              <div className="bg-white rounded-card shadow-card hover:shadow-card-hover transition p-6 text-center">
                <Briefcase className="mx-auto mb-4 text-secondary" size={48} />
                <h3 className="font-bold text-secondary mb-2">Formation Continue</h3>
                <p className="text-gray-700 text-sm">
          ...
          <div className="bg-gray-50 rounded-card p-8 mb-16">
            ...
            <div className="grid md:grid-cols-5 gap-4 max-w-6xl mx-auto">
              <div className="text-center">
                ...
                <h3 className="font-bold text-secondary mb-2 text-sm">Candidature</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-secondary mb-2 text-sm">Présélection</h3>
                <p className="text-gray-700 text-xs">
                  Étude des dossiers
                </p>
              </div>
              <div className="text-center">
                ...
                <h3 className="font-bold text-secondary mb-2 text-sm">Entretien</h3>
                <p className="text-gray-700 text-xs">
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-secondary mb-2 text-sm">Formation</h3>
                <p className="text-gray-700 text-xs">
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-secondary mb-2 text-sm">Intégration</h3>
                <p className="text-gray-700 text-xs">
                  Début de la mission
                </p>
              </div>
