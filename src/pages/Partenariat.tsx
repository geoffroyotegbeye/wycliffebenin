...
const Partenariat = () => {
  const typesPartenariat = [
    ...
    },
    {
      ...
      icon: <Building className="text-primary" size={40} />,
    ...
    },
    {
      ...
      icon: <Church className="text-secondary" size={40} />,
            ...
            {typesPartenariat.map((type, index) => (
              <ScrollAnimation key={index} animation="scale" delay={index * 0.1}>
                <div className="bg-white rounded-card shadow-card hover:shadow-card-hover transition p-6 border-t-4 border-primary">
                  ...
                  <div className="mb-4">
                    <h4 className="font-semibold text-secondary mb-2">Avantages :</h4>
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <span className="text-sm font-semibold text-secondary">Engagement : </span>
                    <span className="text-sm text-primary font-medium">{type.engagement}</span>
                  </div>
                </div>
              </ScrollAnimation>
            ))}
          ...
          <div className="bg-gray-50 rounded-card p-8 mb-16">
            ...
            <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              <div className="text-center">
                ...
                <h3 className="font-bold text-secondary mb-2">Contact Initial</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-secondary mb-2">Rencontre</h3>
                <p className="text-gray-700 text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-secondary mb-2">Accord</h3>
                <p className="text-gray-700 text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-secondary mb-2">Collaboration</h3>
                <p className="text-gray-700 text-sm">
            ...
            {partenairesActuels.map((partenaire, index) => (
              <ScrollAnimation key={index} animation="scale" delay={index * 0.1}>
                <div className="bg-white rounded-card shadow-card hover:shadow-card-hover transition p-6 text-center">
                  ...
                  <p className="text-sm text-primary font-medium">{partenaire.domaine}</p>
                </div>
              </ScrollAnimation>
            ))}
          </div>
            ...
            <ScrollAnimation animation="slideUp" delay={0.1}>
              <div className="bg-white rounded-card shadow-card p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-secondary">Église Grace</div>
            ...
            <ScrollAnimation animation="slideUp" delay={0.2}>
              <div className="bg-white rounded-card shadow-card p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-secondary">SIL International</div>
            ...
            <ScrollAnimation animation="slideUp" delay={0.3}>
              <div className="bg-white rounded-card shadow-card p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-secondary">Ministère Éducation</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <ScrollAnimation animation="scale" delay={0.1}>
              <div className="bg-white rounded-card p-6 shadow-card hover:shadow-card-hover transition text-center border-t-4 border-primary">
                ...
                <h3 className="font-bold text-secondary mb-2">Impact Mesurable</h3>
                <p className="text-gray-700 text-sm">
            ...
            <ScrollAnimation animation="scale" delay={0.2}>
              <div className="bg-white rounded-card p-6 shadow-card hover:shadow-card-hover transition text-center border-t-4 border-secondary">
                <Heart className="mx-auto mb-4 text-secondary" size={40} />
                <h3 className="font-bold text-secondary mb-2">Mission Éternelle</h3>
                <p className="text-gray-700 text-sm">
            ...
            <ScrollAnimation animation="scale" delay={0.3}>
              <div className="bg-white rounded-card p-6 shadow-card hover:shadow-card-hover transition text-center border-t-4 border-primary">
                ...
                <h3 className="font-bold text-secondary mb-2">Réseau Élargi</h3>
                <p className="text-gray-700 text-sm">
            ...
            <ScrollAnimation animation="scale" delay={0.4}>
              <div className="bg-white rounded-card p-6 shadow-card hover:shadow-card-hover transition text-center border-t-4 border-secondary">
                <Award className="mx-auto mb-4 text-secondary" size={40} />
                <h3 className="font-bold text-secondary mb-2">Reconnaissance</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <ScrollAnimation animation="slideUp" delay={0.2}>
                <div className="bg-white rounded-card shadow-card hover:shadow-card-hover transition overflow-hidden">
                  ...
                  />
                  <div className="p-6">
                    <span className="inline-block bg-secondary-50 text-secondary text-xs px-3 py-1 rounded-full mb-3 font-medium">
                      Alphabétisation
                    </span>
                    <h3 className="text-xl font-bold text-secondary mb-3">
                      Programme Dendi
            ...
            <div className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-card p-12">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="bg-white rounded-card p-6 shadow-card">
                    <Phone className="mx-auto mb-3 text-secondary" size={32} />
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center bg-primary text-white px-8 py-3 rounded-button font-semibold hover:bg-primary-600 transition shadow-lg hover:scale-105"
                >
                  Prendre Contact
