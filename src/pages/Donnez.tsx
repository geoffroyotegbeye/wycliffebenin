    ...
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <ScrollAnimation animation="slideUp" delay={0.1}>
              <div className="bg-white rounded-card shadow-card hover:shadow-card-hover transition p-6 text-center">
                ...
                <button className="bg-primary text-white px-6 py-2 rounded-button font-semibold hover:bg-primary-600 transition w-full">
                  Donner
                </button>
              </div>
            </ScrollAnimation>
            ...
            <ScrollAnimation animation="slideUp" delay={0.2}>
              <div className="bg-white rounded-card shadow-card hover:shadow-card-hover transition p-6 text-center">
                <Building className="mx-auto mb-4 text-primary" size={48} />
                <h3 className="text-xl font-bold text-secondary mb-3">
                  Virement Bancaire
                </h3>
                <p className="text-gray-700 mb-4">
                ...
                <button className="bg-secondary text-white px-6 py-2 rounded-button font-semibold hover:bg-secondary-600 transition w-full">
                  Coordonnées
                </button>
              </div>
            </ScrollAnimation>
        ...
        <ScrollAnimation animation="scale">
          <div className="bg-gradient-to-r from-primary to-primary-600 rounded-card shadow-elevated p-12 mb-16 text-center">
          ...
          <div className="bg-gray-50 rounded-card p-8 mb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h3 className="font-bold text-secondary mb-2">Réduction d'Impôt</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start gap-4 mb-6">
                <CheckCircle className="text-primary flex-shrink-0 mt-1" size={24} />
                <div>
                  <h3 className="font-bold text-secondary mb-2">Transparence Totale</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start gap-4">
                <CheckCircle className="text-primary flex-shrink-0 mt-1" size={24} />
                <div>
                  <h3 className="font-bold text-secondary mb-2">Suivi de l'Impact</h3>
                  <p className="text-gray-700">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <ScrollAnimation animation="slideUp" delay={0.1}>
              <div className="bg-white rounded-card shadow-card p-6">
                ...
                <div className="font-bold text-secondary">Sophie M.</div>
            ...
            <ScrollAnimation animation="slideUp" delay={0.2}>
              <div className="bg-white rounded-card shadow-card p-6">
                ...
                <div className="font-bold text-secondary">Pierre K.</div>
            ...
            <ScrollAnimation animation="slideUp" delay={0.3}>
              <div className="bg-white rounded-card shadow-card p-6">
                ...
                <div className="font-bold text-secondary">Pasteur Jean D.</div>
        ...
        <ScrollAnimation animation="scale">
          <div className="bg-secondary rounded-card shadow-elevated p-12 text-center">
            <h2 className="text-4xl font-bold text-white mb-6">
            ...
            <button className="bg-primary text-white px-12 py-4 rounded-button font-semibold hover:bg-primary-600 transition shadow-lg text-lg">
