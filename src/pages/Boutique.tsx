...
const Boutique = () => {
  const categories = [
    ...
    },
    {
      ...
      icon: <Shirt className="text-blue-900" size={40} />,
      produits: [
    ...
    },
    {
      ...
      icon: <Gift className="text-blue-900" size={40} />,
      produits: [
  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                {categorie.produits.map((produit, index) => (
                  <ScrollAnimation key={index} animation="scale" delay={index * 0.1}>
                    <div className="bg-white rounded-card shadow-card hover:shadow-card-hover transition p-6">
                      ...
                      <button className="w-full bg-white text-orange-600 border-2 border-orange-600 px-4 py-2 rounded-button font-semibold hover:bg-orange-700 transition">
                        Ajouter au panier
                      </button>
                    </div>
                  </ScrollAnimation>
          ...
          <div className="bg-gray-50 rounded-card p-8 mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <div className="bg-white rounded-card p-6 shadow-card text-center">
                ...
                <h3 className="font-bold text-blue-900 mb-2">Paiement</h3>
                <p className="text-gray-700 text-sm">
                  Espèces, Mobile Money, Virement bancaire
                </p>
              </div>
              <div className="bg-white rounded-card p-6 shadow-card text-center">
                <ShoppingCart className="mx-auto mb-4 text-blue-900" size={40} />
                <h3 className="font-bold text-blue-900 mb-2">Livraison</h3>
                <p className="text-gray-700 text-sm">
              ...
              <div className="bg-white rounded-card p-6 shadow-card text-center">
                ...
                <h3 className="font-bold text-blue-900 mb-2">Commandes Groupées</h3>
                <p className="text-gray-700 text-sm">
        ...
        {/* Note Importante */}
        <ScrollAnimation animation="slideUp">
          <div className="bg-primary-50 border-l-4 border-orange-600 rounded-card p-6 mb-16">
            <h3 className="font-bold text-blue-900 mb-2">📢 Boutique en Développement</h3>
