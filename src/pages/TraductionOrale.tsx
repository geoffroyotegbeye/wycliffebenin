      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          <div className="bg-primary-50 border-l-4 border-primary p-8 rounded-r-lg">
            <h2 className="text-2xl font-bold text-secondary mb-4">Pourquoi la Traduction Orale ?</h2>
        ...
        <section className="mb-20">
          <h2 className="text-4xl font-bold text-secondary mb-12 text-center">Avantages</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {avantages.map((item, index) => (
              <div key={index} className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition border-l-4 border-primary">
        ...
        <section className="mb-20 bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-secondary mb-12 text-center">Formats Disponibles</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {formats.map((format, index) => (
                <div key={index} className="bg-white rounded-lg p-6 shadow-lg text-center">
                  <div className="text-5xl mb-4">{format.icon}</div>
                  <h3 className="text-lg font-bold text-secondary mb-2">{format.nom}</h3>
        ...
        <section className="mb-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-secondary mb-6">Impact Communautaire</h2>
