...
const TraductionVisuelle = () => {
  const caracteristiques = [
    ...
    },
    {
      ...
      icon: <Smartphone className="text-secondary" size={40} />
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-secondary mb-6">Le Pouvoir de l'Image</h2>
        ...
        <section className="mb-20">
          <h2 className="text-4xl font-bold text-secondary mb-12 text-center">Caractéristiques</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {caracteristiques.map((item, index) => (
              <div key={index} className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition border-t-4 border-primary">
        ...
        <section className="mb-20 bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h2 className="text-3xl font-bold text-secondary mb-6">Projets en Cours</h2>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-2xl">•</span>
                    <div>
                      <h4 className="font-bold text-secondary">Film JESUS</h4>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-2xl">•</span>
                    <div>
                      <h4 className="font-bold text-secondary">Histoires Bibliques Animées</h4>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-primary text-2xl">•</span>
                    <div>
                      <h4 className="font-bold text-secondary">Application Mobile</h4>
