  ...
  return (
    <div className="w-full">
      <div className="relative h-[400px] overflow-hidden">
        <img src='/images/projet-05.webp' alt="Traduction Visuelle" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <section className="mb-20 bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <img src='/images/projet-06.webp' alt="Vidéos" className="rounded-lg shadow-2xl" />
              <div>
